...
const Quote = () => {
  return (
    <section className="border-2 rounded-md flex flex-col items-center justify-center gap-4 text-center px-4 h-64">
      <Image
      ...
      <span>
        - Muriel Strode, &apos;Wind-Wafted Wild Flowers&apos; - The Open Court,
        1903
      </span>
    </section>
  );
